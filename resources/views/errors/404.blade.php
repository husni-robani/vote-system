    ...
    <main class="flex-grow flex flex-col justify-center max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="py-16">
            <div class="text-center">
                ...
                <p class="mt-2 text-base text-gray-500">Looks like you've reached the edge of the internet. Turn back!</p>
                <div class="mt-6">
                    <a href="{{route('election.menu')}}" class="text-base font-medium text-accent hover:text-accent_old">Election List<span aria-hidden="true"> &rarr;</span></a>
                </div>
            </div>
        </div>
    </main>
