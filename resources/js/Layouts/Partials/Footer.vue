      ...
      <div class="mt-8 flex justify-center space-x-6">
        <a v-for="item in navigation.social" :key="item.name" :href="item.href"
          ...
          <component :is="item.icon" aria-hidden="true"
                     class="h-6 w-6  hover:scale-110 transition-transform duration-200"/>
        </a>
      </div>
      <p class="mt-8 text-center text-base text-gray-400">&copy; HMIF 2020 Workflow, Inc. All rights reserved.</p>
    </div>
  </footer>
</template>
